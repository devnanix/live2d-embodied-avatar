...
export const ViewTranslateY = -0.875;
...
// 相対パス
export const ModelPath = './models/mao/';
export const ModelFile = 'niiziro_mao.model3.json';
export const ModelStatesPath = ModelPath + 'states/';
